...
│       │   ├── _stt_correct.py      ← Valorant STT correction: curated mishear map + difflib fuzzy agent-snap (cutoff 0.82, _FUZZY_BLOCK for common words); used as a relay fallback only
