...
1. **`llama-cpp-server` instead of Ollama** ([feedback_llm_runtime_decision.md](C:\Users\alecf\.claude\projects\C--STC-ultronPrototype\memory\feedback_llm_runtime_decision.md)).
